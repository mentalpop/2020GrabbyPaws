...
namespace BoingKit
{
  public static class BoingManager
  {
    ...
    internal static void ExecuteBehaviors()
    {
      ...
      {
        BoingWorkAsynchronous.ExecuteBehaviors(s_behaviorMap);
      }
      else
      #endif
      {
        BoingWorkSynchronous.ExecuteBehaviors(s_behaviorMap);
      }

      Profiler.EndSample();
    }

    internal static void PullBehaviorResults()
    {
    ...
    internal static void ExecuteReactors()
    {
      ...
      if (UseAsynchronousJobs)
      {
        BoingWorkAsynchronous.ExecuteReactors(s_effectorMap, s_reactorMap, s_fieldMap, s_cpuSamplerMap);
      }
      else
      #endif
      {
        BoingWorkSynchronous.ExecuteReactors(s_aEffectorParams, s_reactorMap, s_fieldMap, s_cpuSamplerMap);
      }
    ...
    internal static void ExecuteBones()
    {
      ...
      if (UseAsynchronousJobs)
      {
        BoingWorkAsynchronous.ExecuteBones(s_aEffectorParams, s_bonesMap);
      }
      else
      #endif
      {
        BoingWorkSynchronous.ExecuteBones(s_aEffectorParams, s_bonesMap);
      }
    ...
    internal static void PullBonesResults()
    {
      ...
      if (UseAsynchronousJobs)
      {
        BoingWorkAsynchronous.PullBonesResults(s_aEffectorParams, s_bonesMap);
      }
      else
      #endif
      {
        BoingWorkSynchronous.PullBonesResults(s_aEffectorParams, s_bonesMap);
      }
