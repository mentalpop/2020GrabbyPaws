...
public static class ES3
{
    ...
    public static void Save<T>(string key, T value, string filePath, ES3Settings settings=null)
	{
    ...
    /// <param name="value">The value we want to save.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void Save<T>(string key, T value, ES3Settings settings=null)
    {
        if (settings == null)
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void SaveRaw(byte[] bytes, string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="bytes">The bytes we want to store.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void SaveRaw(byte[] bytes, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="filepath">The relative or absolute path of the file we want to store our bytes to.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void SaveRaw(string str, string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="str">The string we want to store.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void SaveRaw(string str, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void AppendRaw(byte[] bytes, string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="filepath">The relative or absolute path of the file we want to append our bytes to.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void AppendRaw(string str, string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="bytes">The bytes we want to append.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void AppendRaw(string str, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	public static void SaveImage(Texture2D texture, string imagePath, ES3Settings settings=null)
	{
	...
	/// <param name="texture">The Texture2D we want to save as a JPG or PNG.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void SaveImage(Texture2D texture, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
    ...
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static object Load(string key, string filePath, ES3Settings settings=null)
    {
    ...
    /// <param name="key">The key which identifies the value we want to load.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static object Load(string key, ES3Settings settings=null)
    {
    ...
    /// <param name="filePath">The relative or absolute path of the file we want to load from.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static T Load<T>(string key, string filePath, ES3Settings settings=null)
	{
    ...
    /// <param name="key">The key which identifies the value we want to load.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static T Load<T>(string key, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
    ...
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static T Load<T>(string key, string filePath, T defaultValue, ES3Settings settings=null)
	{
    ...
    /// <param name="defaultValue">The value we want to return if the file or key does not exist.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static T Load<T>(string key, T defaultValue, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
    ...
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void LoadInto(string key, string filePath, object obj, ES3Settings settings=null)
    {
    ...
    /// <param name="obj">The object we want to load the value into.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void LoadInto(string key, object obj, ES3Settings settings=null)
    {
    ...
    /// <param name="obj">The object we want to load the value into.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void LoadInto<T>(string key, string filePath, T obj, ES3Settings settings=null)  where T : class
	{
    ...
    /// <param name="obj">The object we want to load the value into.</param>
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void LoadInto<T>(string key, T obj, ES3Settings settings=null) where T : class
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static byte[] LoadRawBytes(string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static byte[] LoadRawBytes(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="filePath">The relative or absolute path of the file we want to load as a byte array.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string LoadRawString(string filePath, ES3Settings settings=null)
	{
	...
	/// <summary>Loads the default file as a byte array.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string LoadRawString(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static Texture2D LoadImage(string imagePath, ES3Settings settings=null)
	{
	...
	/// <summary>Loads a PNG or JPG as a Texture2D.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static Texture2D LoadImage(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
    ...
    public static byte[] Serialize<T>(T value, ES3Settings settings=null)
    {
        ...
        using (var stream = new System.IO.MemoryStream(settings.bufferSize))
        {
    ...
    /// <param name="settings">The settings we want to use to override the default settings.</param>
    public static void DeleteFile(string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void DeleteFile(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	public static void CopyFile(string oldFilePath, string newFilePath, ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
	...
	/// <param name="oldSettings">The settings we want to use when copying the old file.</param>
	/// <param name="newSettings">The settings we want to use when creating the new file.</param>
	public static void CopyFile(ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
        if (oldSettings == null)
            oldSettings = new ES3Settings();

        if (newSettings == null)
            newSettings = new ES3Settings();
	...
	public static void RenameFile(string oldFilePath, string newFilePath, ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
	...
	/// <param name="oldSettings">The settings for the file we want to rename.</param>
	/// <param name="newSettings">The settings for the file we want our source file to be renamed to.</param>
	public static void RenameFile(ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
        if (oldSettings == null)
            oldSettings = new ES3Settings();
	...
	public static void CopyDirectory(string oldDirectoryPath, string newDirectoryPath, ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
	...
	/// <param name="oldSettings">The settings we want to use when copying the old file.</param>
	/// <param name="newSettings">The settings we want to use when creating the new file.</param>
	public static void CopyDirectory(ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
        if (oldSettings == null)
            oldSettings = new ES3Settings();
	...
	/// <param name="oldSettings">The settings for the file we want to rename.</param>
	/// <param name="newSettings">The settings for the file we want our source file to be renamed to.</param>
	public static void RenameDirectory(string oldDirectoryPath, string newDirectoryPath, ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
	...
	/// <param name="oldSettings">The settings for the file we want to rename.</param>
	/// <param name="newSettings">The settings for the file we want our source file to be renamed to.</param>
	public static void RenameDirectory(ES3Settings oldSettings=null, ES3Settings newSettings=null)
	{
        if (oldSettings == null)
            oldSettings = new ES3Settings();
	...
	/// <summary>Deletes the directory at the given path using the settings provided.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void DeleteDirectory(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void DeleteKey(string key, string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="key">The key we want to delete.</param>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void DeleteKey(string key, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	public static bool KeyExists(string key, string filePath, ES3Settings settings=null)
	{
	...
	public static bool KeyExists(string key, ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	/// <returns>True if the file exists, otherwise False.</returns>
	public static bool FileExists(string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	/// <returns>True if the file exists, otherwise False.</returns>
	public static bool FileExists(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	/// <returns>True if the folder exists, otherwise False.</returns>
	public static bool DirectoryExists(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetKeys(string filePath, ES3Settings settings=null)
	{
	...
	/// <summary>Gets an array of all of the key names in a file.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetKeys(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetFiles(string directoryPath, ES3Settings settings=null)
	{
	...
	/// <summary>Gets an array of all of the file names in a directory.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetFiles(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetDirectories(string directoryPath, ES3Settings settings=null)
	{
	...
	/// <summary>Gets an array of all of the sub-directory names in a directory.</summary>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static string[] GetDirectories(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void CreateBackup(string filePath, ES3Settings settings=null)
	{
	...
	/// If a backup already exists it will be overwritten, so you will need to ensure that the old backup will not be required before calling this method.</remarks>
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	public static void CreateBackup(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	public static bool RestoreBackup(string filePath, ES3Settings settings=null)
	{
	...
	/// <param name="settings">The settings we want to use to override the default settings.</param>
	/// <returns>True if a backup was restored, or False if no backup could be found.</returns>
	public static bool RestoreBackup(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
	...
	public static DateTime GetTimestamp(string filePath, ES3Settings settings=null)
	{
	...
	public static DateTime GetTimestamp(ES3Settings settings=null)
	{
        if (settings == null)
            settings = new ES3Settings();
    ...
    public static void StoreCachedFile(string filePath, ES3Settings settings=null)
    {
    ...
    /// <param name="settings">The settings of the file we want to store to.</param>
    public static void StoreCachedFile(ES3Settings settings=null)
    {
        if (settings == null)
            settings = new ES3Settings();
    ...
    /// <param name="filePath">The filename or path of the file we want to store the cached file to.</param>
    /// <param name="settings">The settings of the file we want to store to.</param>
    public static void CacheFile(string filePath, ES3Settings settings=null)
    {
    ...
    /// <summary>Stores a cached file to persistent storage.</summary>
    /// <param name="settings">The settings of the file we want to store to.</param>
    public static void CacheFile(ES3Settings settings=null)
    {
        if (settings == null)
            settings = new ES3Settings();
